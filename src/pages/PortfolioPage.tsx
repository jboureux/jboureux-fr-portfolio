    ...
    <>
      ...
      <MaxWidthWrapper className="my-16">
        <div className="relative mx-auto text-center flex flex-col items-center">
          ...
          <h2 className="relative leading-snug w-fit tracking-wide text-balance mb-8 text-gray-700 text-xl md:text-2xl">
            Toutes les étapes de ma carrière !
          </h2>
        </div>
        <Timeline timelineItems={career} />
      </MaxWidthWrapper>
      <MaxWidthWrapper className="my-16">
        <div className="relative mx-auto text-center flex flex-col items-center">
          <h2
      ...
      <MaxWidthWrapper className="my-16">
        <div className="relative mx-auto text-center flex flex-col items-center">
          ...
          <h2 className="relative leading-snug w-fit tracking-wide text-balance mb-8 text-gray-700 text-xl md:text-2xl">
            Dans un cadre scolaire, ou personnel: retrouvez ici les tous les
      ...
      <MaxWidthWrapper className="my-16">
        <div className="relative mx-auto text-center flex flex-col items-center">
          ...
          <h2 className="relative leading-snug w-fit tracking-wide text-balance mb-8 text-gray-700 text-xl md:text-2xl">
            Tu as une idée et tu as besoin d'un développeur web ? N'hésites pas
            à prendre contact avec moi tous mes liens sont là !
          </h2>
        </div>
